...
\begin{figure}[!h]
\centering\small
\subfloat[Order Flow]{\resizebox{0.45\textwidth}{!}{
\input{figures/order_flow}}\label{fig:orderflow}} \hspace{0.09\textwidth}
\subfloat[User Rank]{\resizebox{0.45\textwidth}{!}{
\input{figures/user_rank}}\label{fig:userrank}}
