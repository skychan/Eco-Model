...
\documentclass[a0paper,portrait]{"../templates/Aalborg University Poster/baposter"}
...
%{
  %this can be commented out or replaced by a company/department logo
%  \includegraphics[height=0.75\headerheight]{QSY}
%}
...
\begin{center}
  \includegraphics[scale = 0.5]{ZJDX}
...
\begin{posterbox}[name=refs,column=2,below=feedback,above=bottom]{Bibliography}
