...
The life cycle management of resource contains its vicissitude, which is the basis of the following extended modes in \autoref{fig:modes}.
\begin{figure}[htbp]
    \centering
...
% Since the schedule in service is a single machine scheduling problem that not on  what we focus in this study, we only discuss the job scheduling in resource.
